...
class PowerDischargeStationToGridMessage(AbstractResultMessage):
    """Description for the PowerDischargeStationToGridMessage class"""

    CLASS_MESSAGE_TYPE = "PowerDischargeStationToGrid"
    ...
    def __eq__(self, other: Any) -> bool:
        return (
            ...
            isinstance(other, PowerDischargeStationToGridMessage) and
    ...
    @classmethod
    def _check_usareer_id(cls, user_id: int) -> bool:
    ...
    @classmethod
    def from_json(cls, json_message: Dict[str, Any]) -> Optional[PowerDischargeStationToGridMessage]:
...
PowerDischargeStationToGridMessage.register_to_factory()
