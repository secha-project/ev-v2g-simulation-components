...
class PowerDischargeCarToStationMessage(AbstractResultMessage):
    """Description for the PowerDischargeCarToStation class"""

    CLASS_MESSAGE_TYPE = "PowerDischargeCarToStation"
    ...
    def __eq__(self, other: Any) -> bool:
        return (
            ...
            isinstance(other, PowerDischargeCarToStationMessage) and
    ...
    @classmethod
    def from_json(cls, json_message: Dict[str, Any]) -> Optional[PowerDischargeCarToStationMessage]:
...
PowerDischargeCarToStationMessage.register_to_factory()
