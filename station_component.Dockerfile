...
LABEL org.opencontainers.image.description "Docker image for the v2g station component for the SimCES platform."
...
CMD [ "python3", "-u", "-m", "station_component.station_component" ]
